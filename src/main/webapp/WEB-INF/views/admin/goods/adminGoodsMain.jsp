   ...
   <c:choose>
     ...
     <c:forEach var="item" items="${newGoodsList }">
			 <TR>
				...
				<TD >
					<a href="/admin/goods/update/${item.goodsId }">
...
<!--    <H3>상품등록하기</H3>-->
    <DIV id="search">
<!--		<input type="submit" value="상품 등록하기" onclick="location.href='/admin/goods/save';">-->
		<a href="/admin/goods/save" role="button" class="btn btn-primary">상품 등록</a>
    </DIV>
